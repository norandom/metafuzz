    ...
    def deliver(data,msg_id)
        begin
            ...
            unless @reuse_process
                ...
                @debugger.puts "sxe -c \"r;!exploitable -m;lm v;.echo xyzzy;.kill;q\" av"
                @debugger.puts "sxe -c \"r;!exploitable -m;lm v;.echo xyzzy;.kill;q\" sov"
                @debugger.puts "sxe -c \"r;!exploitable -m;lm v;.echo xyzzy;.kill;q\" sbo"
                @debugger.puts "sxe -c \"r;!exploitable -m;lm v;.echo xyzzy;.kill;q\" ii"
                @debugger.puts "sxe -c \"r;!exploitable -m;lm v;.echo xyzzy;.kill;q\" gp"
                @debugger.puts "sxe -c \"r;!exploitable -m;lm v;.echo xyzzy;.kill;q\" iov"
