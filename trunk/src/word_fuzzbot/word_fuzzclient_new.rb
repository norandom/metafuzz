    ...
    def deliver(data,msg_id)
        begin
            ...
            unless @reuse_process
                ...
                @debugger.puts "sxe -c \"r;!exploitable -m;lm v;.echo xyzzy;.kill;gn\" av"
                @debugger.puts "sxe -c \"r;!exploitable -m;lm v;.echo xyzzy;.kill;gn\" sov"
                @debugger.puts "sxe -c \"r;!exploitable -m;lm v;.echo xyzzy;.kill;gn\" sbo"
                @debugger.puts "sxe -c \"r;!exploitable -m;lm v;.echo xyzzy;.kill;gn\" ii"
                @debugger.puts "sxe -c \"r;!exploitable -m;lm v;.echo xyzzy;.kill;gn\" gp"
                @debugger.puts "sxe -c \"r;!exploitable -m;lm v;.echo xyzzy;.kill;gn\" iov"
